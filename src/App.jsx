...
function AppInner(){
  ...
  const uSt=(id,idx,f,v)=>{setProt(o=>{const fn={...o[id]};if(id==="27/59"){const k=idx<3?"stages27":"stages59";const ri=idx<3?idx:idx-3;const s=[...fn[k]];s[ri]={...s[ri],[f]:v};return{...o,[id]:{...fn,[k]:s}}}if(id==="81"){const k=idx<3?"stages81u":"stages81o";const ri=idx<3?idx:idx-3;const s=[...fn[k]];s[ri]={...s[ri],[f]:v};return{...o,[id]:{...fn,[k]:s}}}if(id==="32"){const k=idx<2?"stages32r":"stages32f";const ri=idx<2?idx:idx-2;const s=[...fn[k]];s[ri]={...s[ri],[f]:v};return{...o,[id]:{...fn,[k]:s}}}if(id==="87"){const s=[...fn.stages87];s[idx]={...s[idx],[f]:v};return{...o,[id]:{...fn,stages87:s}}}const s=[...fn.stages];s[idx]={...s[idx],[f]:v};return{...o,[id]:{...fn,stages:s}}})};
